...
-- File management
-- vim.keymap.set('n', '<leader>e', vim.cmd.Ex, { desc = 'Exit terminal mode' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>pf', builtin.find_files, { desc = '[P]roject [F]iles' }) -- prev [S]earch [F]iless
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>e', MiniFiles.open, { desc = 'MiniFiles open' })
